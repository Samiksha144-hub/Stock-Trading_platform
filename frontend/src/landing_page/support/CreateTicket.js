    ...
    return ( 
        ...
        <div className='row p-5 border-bottom'>
            ...
            <div className='col-4 p-2 mt-2 mb-2'>
                <h4 className=""><i class="fa-solid fa-circle-plus fa-sm"></i> Account Opening</h4>
                <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Online Account Opening</a><br/>
                <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Ofline Account Opening</a><br/>
            ...
            <div className='col-4 p-2 mt-2 mb-2'>
                <h4 className=""><i class="fa-solid fa-user fa-sm"></i>Your Zerodha Account</h4>
                ...
                <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Company, partnership and Segment Addition</a><br/>
            ...
            <div className='col-4 p-2 mt-2 mb-2'>
                <h4 className=""><i class="fa-solid fa-chart-column fa-sm"></i>Your Zerodha Account</h4>
            ...
            <div className='col-4 p-2 mt-2 mb-2'>
                <h4 className=""><i class="fa-solid fa-circle-plus fa-sm"></i>Funds</h4>
            ...
            <div className='col-4 p-2 mt-2 mb-2'>
                <h4 className=""><i class="fa-solid fa-circle-plus fa-sm"></i>Console</h4>
            ...
            <div className='col-4 p-2 mt-2 mb-2'>
                <h4 className=""><i class="fa-regular fa-circle fa-sm"></i>Coin</h4>
                ...
                <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Buying and Selling Through </a><br/>
                <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Starting an SIP</a><br/>
                <a href="" style={{textDecoration:"none" , lineHeight:"2.5"}}>Managing your Protfolio</a><br/>
